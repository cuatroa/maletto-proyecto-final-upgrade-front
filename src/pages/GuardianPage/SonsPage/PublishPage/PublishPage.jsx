...
export default function PublishPage() {
  ...
  const onSubmit = (values) => {
    ...
    axios
      .post(`${apiUrl}/location-space`, formData, {
  ...
  return (
    <div className="container">
      <div className="container-noNavbar">
        <Link className="icon-atras icon-publish" to="/guardian">
          {" "}
        </Link>
                ...
                <div>
                  <div>
                    ...
                    <select
                      ...
                      name="type"
                      id="type"
                      className="input-publish input-select"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      name="title"
                      id="title"
                      placeholder="El maletero de John..."
                      className="input-publish"
                      ref={register({ required: true, min: 1 })}
                    />
                    <hr />
